...
<body>
	...
	<div id="site">
		...
		<div id="navigation">
			<div id="social">
				<a href='#'><svg id="twitter" class="custom-icon" version="1.1"
						xmlns="http://www.w3.org/2000/svg"
						xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100">
	<path class="inner-shape" style="opacity: 1; fill: rgb(46, 167, 254);"
...
</svg></a> <a href="www.instagram.com"><svg id="instagram"
						class="custom-icon" version="1.1"
						xmlns="http://www.w3.org/2000/svg"
						xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100">
	<path class="inner-shape" style="opacity: 1; fill: rgb(46, 167, 254);"
							transform="translate(25,25) scale(0.5)"
...
</svg></a> <a href="#"><svg id="facebook-square" class="custom-icon"
	...
	<path class="inner-shape" style="opacity: 1; fill: rgb(46, 167, 254);"
		...
		<a href="ChampionsLeague.php">
			<div id="Logos">
				<img class="bild" src="Logo_uefa_2012.png" alt="Champions League">
			</div>
		</a> <a href="#"><div id="Logos1">
				<img class="bild" src="UK_Premier_League_logo.png" alt="Premier League">
			</div></a>
